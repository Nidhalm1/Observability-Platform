...
func main() {
	...
	r.Handle("/metrics", promhttp.HandlerFor(
		prometheus.DefaultGatherer, //DefaultGatherer is connected to the same default registry. where we registred all metrics  and prometheus. library simplfy for us the work 
